...
contract ClockAuctionBase {
    ...
    event DutchAuctionCreated(address seller, address nftAddress, uint256 tokenId, uint256 startingPrice, uint256 endingPrice, uint256 duration);
    event DutchAuctionSuccessful(address seller, address nftAddress, uint256 tokenId, uint256 totalPrice, address winner);
    event DutchAuctionCancelled(address seller, address nftAddress, uint256 tokenId);
    ...
    function _cancelAuction(address _nft, uint256 _tokenId, address _seller) internal {
        ...
        DutchAuctionCancelled(_seller, _nft, _tokenId);
    }
        ...
        returns (uint256)
    {
        ...
        // Tell the world!
        DutchAuctionSuccessful(auction.seller, _nft, _tokenId, price, msg.sender);
    ...
    /// @dev Gets the NFT object from an address.
